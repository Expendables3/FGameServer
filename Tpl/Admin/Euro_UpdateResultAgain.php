...
<div id="middle">
    ...
    <?php if($block == 1) {?>
       <form id="form1" name="form1" method="post" action="?mod=Index&act=euro_updateResultAgain">
                Match 
    ...
    <?php }else if($block == 2){ ?>
       ...
       <form id="form2" name="form2" method="post" action="?mod=Index&act=euro_updateResultAgain">
    ...
    <?php }else if($block == 3){ ?> 
     ...
     <form id="form3" name="form3" method="post" action="?mod=Index&act=euro_updateResultAgain">   
       <?php
                echo '<input type="hidden" name="MatchId" value="'.$MatchId.'" />' ;
    ...
    <?php }else if($block == 4){ ?>
        ...
        <?php echo $message ; 
            ...
            {
                ?>
         <form id="form4" name="form4" method="post" action="?mod=Index&act=euro_updateResultAgain"> 
         <?php
                echo '<input type="hidden" name="MatchId" value="'.$MatchId.'" />' ; 
         ?>        
