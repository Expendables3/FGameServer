...
<div id="middle">
    ...
    <div id="center-column">    
       <form id="form2" name="form2" method="post" action="?mod=Index&act=AddItem">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="40%">Comment:<input type="text" name="Comment" size="26" value="<?php if(isset($_COOKIE['Comment'])) echo $_COOKIE['Comment'] ; ?>"  /></td>                
                </tr>
